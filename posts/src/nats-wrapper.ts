...
class NatsWrapper {
  //define this _client property AFTER we connect to nats and get back a client. we will then assign that client as the value of _client! ? means this property might be undefined
  private client?: Stan;
