...
//whenever we update a document, we need to increment its version! the way to do this is, calling save()! because the updateIfCurrent package already updates the version when we call save, so just the functionality of that package!
