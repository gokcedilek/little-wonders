...
//will be used in getInitialProps - this func can be executed both on the client side and on the server side, so we need to make requests according to that!
export default ({ req }) => {
