...
export const signupHelper = () => {
  ...
  //obtaining a cookie synchronously: we cant introduce a dependency to our auth service from the other services - so, we need to write a generic signUpHelper which simulates the process of obtaining a cookie:
